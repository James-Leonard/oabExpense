# [OAB Expense](https://appseed.us/product/datta-able/django/)
...
And used in developing this Expenses Project, Credit to AppSeed for the UI

- 👉 [Datta Able Django](https://appseed.us/product/datta-able/django/) - `Original Appseed Template`
- 👉 [OAB Expense](https://oabexpense-production.up.railway.app) - `LIVE demo` 
...
```bash
$ # Get the code
$ git clone https://github.com/James-Leonard/oabExpense.git
$ cd oabExpense
```
